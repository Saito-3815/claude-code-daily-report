...
export const createReportRequestSchema = createReportRequestBaseSchema.extend({
  visits: z.array(createVisitRecordRequestSchema).optional().default([]),
  problems: z.array(createProblemRequestSchema).optional().default([]),
  plans: z.array(createPlanRequestSchema).optional().default([]),
});
